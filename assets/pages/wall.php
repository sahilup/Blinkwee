...
<div class="container col-9 rounded-0 d-flex justify-content-between">
        <div class="col-8">
            <div class="card mt-4" >
                <div class="card-title d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex align-items-center p-2">
                        <img src="assets/images/profile/profile.jpg" alt="" height="30" class="rounded-circle border">&nbsp;&nbsp;Sahil Upadhyay
                    </div>
                    <div class="p-2">
                        <i class="bi bi-three-dots-vertical"></i>
                    </div>
                </div>
                <img src="assets/images/posts/post2.webp" class="" alt="...">
                <h4 style="font-size: x-larger" class="p-2 border-bottom"><i class="bi bi-heart"></i>&nbsp;&nbsp;<i
                        class="bi bi-chat-left"></i>
                </h4>
                <div class="card-body">
                    This is an alternative text for the caption. 
                    This will be replaced by the caption text written by the user. 
                ...
                <div class="input-group p-2 border-top">
                    ...
                    <button class="btn btn-outline-dark rounded-0 border-0" type="button"
            ...
            <div class="card mt-4">
                ...
                <img src="assets/images/posts/post3.webp" class="" alt="...">
                <h4 style="font-size: x-larger" class="p-2 border-bottom"><i class="bi bi-heart"></i>&nbsp;&nbsp;<i
                        class="bi bi-chat-left"></i>
                </h4>
                <div class="card-body">
            ...
            <div class="card mt-4">
                ...
                <img src="assets/images/posts/post4.webp" class="" alt="...">
                <h4 style="font-size: x-larger" class="p-2 border-bottom"><i class="bi bi-heart"></i>&nbsp;&nbsp;<i
                        class="bi bi-chat-left"></i>
                </h4>
                <div class="card-body">
            ...
            <div class="card mt-4">
                ...
                <img src="assets/images/posts/post.webp" class="" alt="...">
                <h4 style="font-size: x-larger" class="p-2 border-bottom"><i class="bi bi-heart"></i>&nbsp;&nbsp;<i
                        class="bi bi-chat-left"></i>
                </h4>
                <div class="card-body">
            ...
            <div class="card mt-4">
                ...
                <img src="assets/images/posts/post5.webp" class="" alt="...">
                <h4 style="font-size: x-larger" class="p-2 border-bottom"><i class="bi bi-heart"></i>&nbsp;&nbsp;<i
                        class="bi bi-chat-left"></i>
                </h4>
                <div class="card-body">
        ...
        <div class="col-4 mt-4 p-3">
            ...
            <div>
                <h6 class="text-muted p-2">Suggested for you</h6>
                ...
                <div class="d-flex justify-content-between">
                    <div class="d-flex align-items-center p-2">
                        ...
                        <div>&nbsp;&nbsp;</div>
                        <div class="d-flex flex-column justify-content-center">
                            <h6 style="margin: 0px;font-size: small;">Dinesh Kumar</h6>
                            <p style="margin:0px;font-size:small" class="text-muted">@dineshkumar</p>
                        </div>
                    </div>
                    <div class="d-flex align-items-center">
                        <button class="btn btn-sm btn-dark">Follow</button>
                ...
                <div class="d-flex justify-content-between">
                    <div class="d-flex align-items-center p-2">
                        ...
                        <div>&nbsp;&nbsp;</div>
                        <div class="d-flex flex-column justify-content-center">
                            <h6 style="margin: 0px;font-size: small;">Steve Jobs</h6>
                            <p style="margin:0px;font-size:small" class="text-muted">@Stevejobs</p>
                        </div>
                    </div>
                    <div class="d-flex align-items-center">
                        <button class="btn btn-sm btn-dark">Follow</button>
                ...
                <div class="d-flex justify-content-between">
                    <div class="d-flex align-items-center p-2">
                        ...
                        <div>&nbsp;&nbsp;</div>
                        <div class="d-flex flex-column justify-content-center">
                            <h6 style="margin: 0px;font-size: small;">Bill Gates</h6>
                            <p style="margin:0px;font-size:small" class="text-muted">@billgates</p>
                        </div>
                    </div>
                    <div class="d-flex align-items-center">
                        <button class="btn btn-sm btn-dark">Follow</button>
                ...
                <div class="d-flex justify-content-between">
                    <div class="d-flex align-items-center p-2">
                        ...
                        <div>&nbsp;&nbsp;</div>
                        <div class="d-flex flex-column justify-content-center">
                            <h6 style="margin: 0px;font-size: small;">Akif</h6>
                            <p style="margin:0px;font-size:small" class="text-muted">@iamakifurrahman</p>
                        </div>
                    </div>
                    <div class="d-flex align-items-center">
                        <button class="btn btn-sm btn-dark">Follow</button>
